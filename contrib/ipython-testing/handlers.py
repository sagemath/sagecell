...
class ZMQStreamHandler(tornado.websocket.WebSocketHandler):
    def open(self, kernel_id):
        self.km = self.application.kernel_manager
...
class IOPubHandler(ZMQStreamHandler):
    ...
    def on_first_message(self, msg):
        ...
        self.time_to_dead = km.time_to_dead #add to km if needed
        self.first_beat = km.first_beat #add to km if needed
...
"""
    ...
    def kernel_died(self):
        self.application.kernel_manager.end_session(self.kernel_id)
        self.write_message(
